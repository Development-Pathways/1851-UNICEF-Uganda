...
* moderate disability (DISABILITY3):  any 1 domain/question is coded A LOT OF DIFFICULTY or CANNOT DO AT ALL ("A lot more" for behaviour)
...
replace SSHD_2to4 = 2 if SEE_IND_2to4==2 | HEAR_IND_2to4 ==2 | WALK_IND_2to4 ==2 | MOT_IND_2to4==2 | COM_IND_2to4==2 | LEARN_IND_2to4==2 | PLAY_IND_2to4==2
replace SSHD_2to4 = 3 if SEE_IND_2to4==3 | HEAR_IND_2to4 ==3 | WALK_IND_2to4 ==3 | MOT_IND_2to4==3 | COM_IND_2to4==3 | LEARN_IND_2to4==3 | PLAY_IND_2to4==3 | BEH_IND_2to4==4
replace SSHD_2to4 = 4 if SEE_IND_2to4==4 | HEAR_IND_2to4 ==4 | WALK_IND_2to4 ==4 | MOT_IND_2to4==4 | COM_IND_2to4==4 | LEARN_IND_2to4==4 | PLAY_IND_2to4==4
